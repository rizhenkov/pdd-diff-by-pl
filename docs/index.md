...
Если вам статья покажется полезной, поставьте пожалуйста [Star на github](https://github.com/rizhenkov/pdd-diff-by-pl) и перешлите ссылку на неё своим знакомым автолюбителям, которым она может быть интересна.
